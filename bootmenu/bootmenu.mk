...
PRODUCT_COPY_FILES += \
	...
	${bm_device}/profiles/2nd-init/init.b2g.rc:system/bootmenu/2nd-init/init.b2g.rc \
...
PRODUCT_COPY_FILES += \
	...
	${bm_device}/profiles/2nd-boot/hboot-uart.cfg:system/bootmenu/2nd-boot/hboot-uart.cfg \
	${bm_device}/profiles/2nd-boot/zImage-uart:system/bootmenu/2nd-boot/zImage-uart \
